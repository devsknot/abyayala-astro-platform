// Función para obtener artículos con sus categorías (endpoint que no entra en conflicto con content.js)
export async function onRequest(context) {
  // Logs detallados para depuración
  console.log('[articlescontent.js] onRequest invocado');
  ...
  try {
    ...
    console.error('Error en articlescontent.js:', error);
    return new Response(JSON.stringify({ 
