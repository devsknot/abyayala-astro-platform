// Endpoint API para lista de artículos con nombre completamente diferente
export async function onRequest(context) {
  console.log('>>> ENTRANDO A ENDPOINT ALLNEWS (NUEVO NOMBRE) <<<');
  ...
  try {
    console.log('Obteniendo todos los artículos desde allnews.js (endpoint nuevo)');
