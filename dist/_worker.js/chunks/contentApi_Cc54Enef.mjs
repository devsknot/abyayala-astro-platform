 ...
 */
async function getAllArticles(origin = '') {
 ...
 */
async function getArticleBySlug(slug, origin = '') {
 ...
 */
async function getArticlesByCategory(category, origin = '') {
 ...
 */
async function getAllCategories(origin = '') {
...
export { getArticlesByCategory as a, getArticleBySlug as b, getAllArticles as c, getAllCategories as g };
